...
import type { Supply, ProductIngredient } from "@/types";

/** Sale shape specific to projection — Supabase join returns nested product_ingredients. */
interface ProjectionSale {
  id: string;
  quantity: number;
  sale_date: string;
  products: {
