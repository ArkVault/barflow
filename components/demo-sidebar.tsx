...
export function DemoSidebar({
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-72 z-50 hidden md:block">
      <div className="h-full p-4">
        <div className="h-full neumorphic rounded-[2.5rem] bg-background/90 px-5 py-5 flex flex-col">
          {/* Logo */}
          <div className="mb-4">
          ...
          <div className="space-y-1 pt-3 mt-3 border-t border-border/30">
            {/* Establishment & User Info (dashboard mode) */}
            {isDashboard && (userName || establishmentName) && (
            ...
            {/* Bottom nav items (dashboard mode) */}
            {isDashboard &&
            ...
            {/* Upgrade Plan Button (dashboard mode) */}
            {isDashboard && (
