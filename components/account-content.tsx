...
export default function AccountContent() {
  ...
  const [activeTab, setActiveTab] = useState<
    "profile" | "security" | "subscription" | "connections"
  >("profile");
  ...
  const currentPlanIsTopTier = subscription.planType === "enterprise";
                  ...
                  <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div className="relative neumorphic rounded-2xl p-6 space-y-5 hover:scale-[1.02] transition-transform border border-blue-500/20 bg-gradient-to-br from-blue-500/5 via-transparent to-cyan-500/5">
                      <div className="flex items-center gap-3 pt-2">
                        ...
                        <div>
                          <h5 className="text-xl font-bold">Starter</h5>
                          <p className="text-sm text-muted-foreground">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {language === "es"
                            ...
                            : `Up to ${PLAN_PRICING.starter.maxUsers} users`}
                        </p>

                        <div className="mt-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                          <p className="text-sm font-medium text-green-600 dark:text-green-400">
                            💰{" "}
                            {language === "es" ? "Plan anual" : "Yearly plan"}
                          </p>
                          <p className="text-xs text-muted-foreground">
                            $
                            ...
                            {language === "es"
                              ? `/mes ($${PLAN_PRICING.starter.yearlyTotal.toLocaleString("es-MX")}/año)`
                              : `/mo ($${PLAN_PRICING.starter.yearlyTotal.toLocaleString("es-MX")}/yr)`}
                          </p>
                          <p className="text-xs font-medium text-green-500 mt-1">
                            {language === "es"
                              ? `Ahorra $${((PLAN_PRICING.starter.monthly - PLAN_PRICING.starter.yearly) * 12).toLocaleString("es-MX")}/año`
                              : `Save $${((PLAN_PRICING.starter.monthly - PLAN_PRICING.starter.yearly) * 12).toLocaleString("es-MX")}/yr`}
                          </p>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          MXN + IVA
                    ...
                    <div className="relative neumorphic rounded-2xl p-6 space-y-5 hover:scale-[1.02] transition-transform border border-purple-500/20 bg-gradient-to-br from-purple-500/5 via-transparent to-pink-500/5">
                      ...
                      <div className="flex items-center gap-3 pt-2">
                        ...
                        <div>
                          <h5 className="text-xl font-bold">Business</h5>
                          <p className="text-sm text-muted-foreground">
                            {language === "es" ? "1 Sucursal" : "1 Branch"}
                          </p>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {language === "es"
                            ...
                            : `Up to ${PLAN_PRICING.business.maxUsers} users`}
                        </p>
                        ...
                        <div className="mt-3 p-3 rounded-lg bg-purple-500/10 border border-purple-500/20">
                          ...
                          <p className="text-xs text-muted-foreground">
                            ...
                            {language === "es"
                              ? `/mes ($${PLAN_PRICING.business.yearlyTotal.toLocaleString("es-MX")}/año)`
                              : `/mo ($${PLAN_PRICING.business.yearlyTotal.toLocaleString("es-MX")}/yr)`}
                          </p>
                          <p className="text-xs font-medium text-purple-500 mt-1">
                            {language === "es"
                              ? `Ahorra $${((PLAN_PRICING.business.monthly - PLAN_PRICING.business.yearly) * 12).toLocaleString("es-MX")}/año`
                              : `Save $${((PLAN_PRICING.business.monthly - PLAN_PRICING.business.yearly) * 12).toLocaleString("es-MX")}/yr`}
                          </p>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          MXN + IVA
                      ...
                      <ul className="space-y-2">
                        {[
                          ...
                          language === "es"
                            ...
                            : "Inventory & shrinkage protection",
                          language === "es"
                            ? "Proyección de inventario con IA"
                            : "AI inventory projections",
                          language === "es"
                    ...
                    {/* Plan 3: Cadena (2-5 sucursales) */}
                    <div className="relative neumorphic rounded-2xl p-6 space-y-5 hover:scale-[1.02] transition-transform border border-orange-500/20 bg-gradient-to-br from-orange-500/5 via-transparent to-red-500/5">
                      <div className="absolute -top-3 left-4">
                        <div className="inline-flex rounded-full bg-gradient-to-r from-orange-500 to-red-500 px-3 py-1 text-xs font-bold text-white uppercase tracking-wider shadow-lg">
                          {language === "es"
                            ? "Multi-sucursal"
                            : "Multi-branch"}
                        </div>
                      ...
                      <div className="flex items-center gap-3 pt-2">
                        ...
                        <div>
                          <h5 className="text-xl font-bold">Cadena</h5>
                          <p className="text-sm text-muted-foreground">
                            {language === "es"
                              ? "2–5 Sucursales"
                              : "2–5 Branches"}
                      ...
                      <div className="space-y-2">
                        <div className="flex items-baseline gap-2">
                          <span className="text-4xl font-bold">
                            $
                            {PLAN_PRICING.cadena.monthlyPerBranch.toLocaleString(
                              "es-MX",
                            )}
                          </span>
                          <span className="text-muted-foreground text-sm">
                            {language === "es" ? "/sucursal/mes" : "/branch/mo"}
                          </span>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          {language === "es"
                        ...
                        <div className="mt-3 p-3 rounded-lg bg-orange-500/10 border border-orange-500/20">
                          ...
                          <p className="text-xs text-muted-foreground">
                            $
                            {PLAN_PRICING.cadena.yearlyPerBranch.toLocaleString(
                              "es-MX",
                            )}
                            {language === "es" ? "/sucursal/mes" : "/branch/mo"}
                          </p>
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="w-full border-orange-500/50 hover:bg-orange-500/10 hover:border-orange-500 font-semibold"
                      >
                    ...
                    {/* Plan 4: Enterprise (+5 sucursales) */}
                    <div className="relative neumorphic rounded-2xl p-6 space-y-5 hover:scale-[1.02] transition-transform border border-amber-500/20 bg-gradient-to-br from-amber-500/5 via-transparent to-orange-500/5">
                      ...
                      <div className="flex items-center gap-3 pt-2">
                        ...
                        <div>
                          <h5 className="text-xl font-bold">Enterprise</h5>
                          <p className="text-sm text-muted-foreground">
                            {language === "es"
                              ? "+5 Sucursales"
                              : "5+ Branches"}
                      ...
                      <div className="space-y-2">
                        <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-bold">
                            $
                            {PLAN_PRICING.enterprise.baseFee.toLocaleString(
                              "es-MX",
                            )}
                          </span>
                          <span className="text-muted-foreground text-sm">
                            {language === "es" ? "fee base" : "base fee"}
                          </span>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          + $
                          {PLAN_PRICING.enterprise.monthlyPerBranch.toLocaleString(
                            "es-MX",
                          )}
                          {language === "es" ? "/sucursal/mes" : "/branch/mo"}
                          {language === "es"
                            ? ` (anual: $${PLAN_PRICING.enterprise.yearlyPerBranch.toLocaleString("es-MX")})`
                            : ` (yearly: $${PLAN_PRICING.enterprise.yearlyPerBranch.toLocaleString("es-MX")})`}
                        </p>
