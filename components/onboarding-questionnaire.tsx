...
const T = {
  ...
  en: {
    ...
    inventoryManualDesc:
      "Start with an empty list and fill it at your own pace",
...
const cardStyle: React.CSSProperties = {
  ...
  boxShadow:
    "0 25px 60px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.04)",
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between">
        <button className={btnGray} onClick={onBack}>
          ← {t.back}
        </button>
        <button
...
function SlideTeam({
  ...
  t: Translations;
  counts: TeamCounts;
  onCount: (key: string, val: number) => void;
  onNext: () => void;
  onBack: () => void;
}) {
            ...
            >
              ...
              <select
                ...
                style={{
                  ...
                  borderRadius: "0.5rem",
                  color:
                    val > 0 ? "oklch(0.80 0.10 220)" : "oklch(0.55 0.02 30)",
...
function SlideBranches({
  ...
  const canContinue =
    mode === "single" || (mode === "multiple" && Number(branchCount) >= 2);
    ...
    <div className="flex flex-col gap-6">
      ...
      {mode === "multiple" && (
        <div className="flex flex-col gap-1">
          <label
            style={{ color: "oklch(0.65 0.02 60)", fontSize: "0.8125rem" }}
          >
            {t.branchCountLabel}
          </label>
          <input
      ...
      {mode && (
        <div
          ...
          style={{
            background: "oklch(0.65 0.14 220 / 0.10)",
            border: "1px solid oklch(0.65 0.14 220 / 0.25)",
        ...
        >
          ...
          {t.branchPlanBadge}{" "}
          <strong>
            {mode === "single" ? t.branchPlanBar : t.branchPlanChain}
          </strong>
        </div>
      )}
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          >
            <path
              d="M14.5 2.5l3 3-10 10H4.5v-3l10-10z"
              stroke="oklch(0.55 0.02 30)"
              strokeWidth="1.4"
...
function SlideExcelUpload({
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      await markOnboardingComplete(userId, supabase, { team_counts: {} });
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <p style={{ color: "oklch(0.60 0.02 30)", fontSize: "0.875rem" }}>
        {t.uploadDesc}
      </p>
      <div
      ...
      >
        ...
        >
          ...
          <rect
            ...
            height="38"
            rx="3"
            fill="oklch(0.17 0.02 30)"
            stroke={file ? "oklch(0.65 0.14 220 / 0.6)" : "oklch(0.36 0.02 30)"}
            strokeWidth="1.5"
          />
          {/* Folded corner */}
          <path
            d="M24 1 L31 8 L24 8 Z"
            fill={file ? "oklch(0.55 0.12 220 / 0.35)" : "oklch(0.28 0.02 30)"}
            stroke={file ? "oklch(0.65 0.14 220 / 0.6)" : "oklch(0.36 0.02 30)"}
            strokeWidth="1.5"
            strokeLinejoin="round"
          />
          ...
          <line
            ...
            x2="24"
            y2="14"
            stroke={file ? "oklch(0.65 0.14 220 / 0.5)" : "oklch(0.34 0.02 30)"}
            strokeWidth="1.2"
            strokeLinecap="round"
          />
          <line
      ...
      <div className="flex justify-between">
        <button className={btnGray} onClick={onBack} disabled={loading}>
          ← {t.back}
        </button>
        <button
          className={btnPrimary}
      ...
      <ul className="flex flex-col gap-2">
        {t.paymentFeatures.map((f) => (
          <li
            ...
            style={{ color: "oklch(0.78 0.04 160)", fontSize: "0.875rem" }}
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <circle
                cx="7"
...
export function OnboardingQuestionnaire({
  ...
  const [branchMode, setBranchMode] = useState<"single" | "multiple" | null>(
    null,
  );
      ...
      >
        ...
        {TEST_MODE && (
          <button
            ...
            style={{
              ...
              border: "1px solid oklch(0.36 0.02 30)",
              color: "oklch(0.55 0.02 30)",
            }}
        ...
        {slide > 0 && (
          <div className="mb-6">
            <div className="flex justify-between mb-1.5">
              <span
                style={{ color: "oklch(0.50 0.02 30)", fontSize: "0.75rem" }}
              >
            ...
            >
              <div
                ...
                style={{
                  ...
                  background: "oklch(0.65 0.14 220)",
                }}
              />
            </div>
          </div>
        ...
        {slide === 2 && (
          <SlideTeam
            ...
            counts={teamCounts}
            onCount={(key, val) =>
              setTeamCounts((prev) => ({ ...prev, [key]: val }))
            }
            onNext={() => setSlide(3)}
            onBack={() => setSlide(1)}
          />
