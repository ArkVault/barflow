        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Ve métricas y reportes de todas tus sucursales en un solo
                      lugar
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Controla el stock de todas tus sucursales desde un solo
                      panel
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Compara el rendimiento entre sucursales y optimiza
                      operaciones
                    </div>
                  </div>
                </div>
            ...
            <p className="text-xs text-center text-muted-foreground">
              Al hacer upgrade, se te cobrará $2,999 MXN/mes. Puedes cancelar en
              cualquier momento.
            </p>
          </div>
        </DialogContent>
