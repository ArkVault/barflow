      ...
      <div className="max-w-lg w-full neumorphic rounded-2xl p-8 text-center space-y-6 animate-in zoom-in-95 fade-in duration-500">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            {language === "es"
              ? "Para continuar usando Stttock, elige un plan que se adapte a tus necesidades."
              : "To continue using Stttock, choose a plan that fits your needs."}
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            {language === "es"
              ? "Planes desde $1,499 MXN/mes (anual)"
              : "Plans starting at $1,499 MXN/month (yearly)"}
          </p>
        </div>
      </div>
    </div>
