  ...
  useEffect(() => {
    ...
    if (restockId && supplies.length > 0 && !loading) {
      ...
      if (supplyToRestock) {
        ...
        window.history.replaceState({}, "", restockCleanupUrl);
      }
    }
  }, [searchParams, supplies, loading, restockCleanupUrl]);
      ...
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            {language === "es" ? "Cargando insumos..." : "Loading supplies..."}
          </p>
        </div>
      </div>
    );
                        ...
                        percentage={
                          supply.optimal_quantity
                            ? (supply.current_quantity /
                                supply.optimal_quantity) *
                              100
                            : (supply.current_quantity / supply.min_threshold) *
                              100
                        }
