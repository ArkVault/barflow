  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <Card className="neumorphic border-0">
        ...
        <CardContent>
          <div className="text-3xl font-bold text-chart-3">${stats.todaySales.toFixed(2)}</div>
      ...
      <Card className="neumorphic border-0">
        ...
        <CardContent>
          <div className="text-3xl font-bold">${stats.weekSales.toFixed(2)}</div>
          <p className="text-xs text-muted-foreground mt-1">
            Promedio: ${(stats.weekSales / 7).toFixed(2)}/día
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="neumorphic border-0">
        ...
        <CardContent>
          <div className="text-3xl font-bold text-secondary">${stats.monthSales.toFixed(2)}</div>
          <p className="text-xs text-muted-foreground mt-1">
      ...
      <Card className="neumorphic border-0">
        ...
        <CardContent>
          <div className="text-3xl font-bold text-chart-4">
            ${((stats.monthSales / new Date().getDate()) * new Date(new Date().getFullYear(), new Date().getMonth() + 1, 0).getDate()).toFixed(2)}
          </div>
          <p className="text-xs text-muted-foreground mt-1">
