    ...
    const paymentLabel =
      language === "es"
        ...
        : paymentMethod === "cash"
          ...
          : "Card";
    alert(
      `${language === "es" ? "Venta procesada con" : "Sale processed with"} ${paymentLabel}: $${calculateTotal().toFixed(2)}`,
    );
    clearCart();
  };
              ...
              <Card className="neumorphic border-0 p-4 sticky top-4">
                ...
                {cart.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">
                      {language === "es" ? "Carrito vacío" : "Empty cart"}
                    </p>
                  </div>
                ) : (
                  <>
