...
export default function OperacionesPage() {
     ...
     // Demo products (same as in ventas)
     const demoProducts = [
          { id: 1, name: 'Mojito Clásico', price: 8.50, category: 'Cócteles' },
          { id: 2, name: 'Margarita', price: 9.00, category: 'Cócteles' },
          { id: 3, name: 'Piña Colada', price: 10.00, category: 'Cócteles' },
          { id: 4, name: 'Cuba Libre', price: 7.50, category: 'Cócteles' },
          { id: 5, name: 'Tequila Shot', price: 6.00, category: 'Shots' },
          { id: 6, name: 'Cerveza Corona', price: 5.00, category: 'Cervezas' },
          { id: 7, name: 'Whisky Sour', price: 11.00, category: 'Cócteles' },
          { id: 8, name: 'Gin Tonic', price: 9.50, category: 'Cócteles' },
     ];

     const addProductToOrder = (product: typeof demoProducts[0]) => {
          ...
          setSections(sections.map(section => {
               if (section.id === sectionId) {
                    const newTable: Table = {
                         id: `table-${Date.now()}`,
                         name: `Mesa ${section.tables.length + 1}`,
                         x: 20,
                         y: 20,
                         status: 'libre',
                         accounts: [],
                                   ...
                                   <div className="lg:col-span-2 space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                             {demoProducts.map(product => (
                                                  <div
                                                       key={product.id}
                                                       className="neumorphic rounded-2xl p-4 cursor-pointer hover:scale-105 transition-transform"
