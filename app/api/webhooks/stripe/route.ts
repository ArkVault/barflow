...
function getPlanTypeFromPriceId(priceId: string): string {
  ...
  if (priceId === starterMonthly) return "starter_monthly";
  if (priceId === starterYearly) return "starter_yearly";
  if (priceId === businessMonthly) return "business_monthly";
  if (priceId === businessYearly) return "business_yearly";
